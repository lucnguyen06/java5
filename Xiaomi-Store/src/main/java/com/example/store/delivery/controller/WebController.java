...
import com.example.store.delivery.dto.*;
...
import com.example.store.delivery.service.DeliveryOrderService;
...
public class WebController {
    ...
    public WebController(DeliveryOrderService orderService, DeliveryService deliveryService, PaymentService paymentService) {
    ...
    public String createPayment(@ModelAttribute PaymentRequest request, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/delivery/payments";
    }
